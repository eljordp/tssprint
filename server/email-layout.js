...
<tr><td style="padding:28px 32px;background:#101418;border-bottom:4px solid #48bfee"><a href="https://tssprint.com" style="text-decoration:none"><img src="https://tssprint.com/brand/tss-logo.png" width="172" height="88" alt="The Sticker Smith" style="display:block;width:172px;height:88px;border:0;color:#ffffff"></a><p style="margin:16px 0 0;color:#c3cbd1;font-size:11px;line-height:18px;font-weight:bold;letter-spacing:1.6px">CUSTOM PRINT. MADE IN HAYWARD.</p></td></tr>
