...
export const productExamples: Record<string, Example> = {
  ...
  'Backdrops & Displays': { image: eventDesign, caption: 'OTAI · banner and table-cover design mockup', description: 'A wide printed background for a booth or photo area.', details: 'Graphic Only is the print without a frame. With Frame includes a supporting frame. The mockup shows artwork layout; final hardware and dimensions are confirmed in the estimate.', contain: true },
