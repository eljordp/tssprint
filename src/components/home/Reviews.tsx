...
const reviews = [
  {
    ...
    source: 'Google',
    date: 'Jan 2026',
    avatarBg: 'from-primary/30 to-primary/10',
  ...
  },
  {
    ...
    source: 'Google',
    date: 'Feb 2026',
    avatarBg: 'from-pink-500/25 to-pink-500/5',
  ...
  },
  {
    ...
    source: 'Google',
    date: 'Dec 2025',
    avatarBg: 'from-yellow-400/25 to-yellow-400/5',
  ...
  },
  {
    ...
    source: 'Google',
    date: 'Mar 2026',
    avatarBg: 'from-emerald-400/25 to-emerald-400/5',
  ...
  },
  {
    ...
    source: 'Google',
    date: 'Jan 2026',
    avatarBg: 'from-orange-400/25 to-orange-400/5',
            ...
            >
              {reviews.map((review, i) => (
                ...
                >
                  ...
                  <p className="text-foreground mb-5 leading-relaxed">{review.text}</p>
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${review.avatarBg} border border-white/10 flex items-center justify-center shrink-0 shadow-sm`}>
                      <span className={`font-black text-sm ${review.avatarText}`}>{initials(review.name)}</span>
                    </div>
