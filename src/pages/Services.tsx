...
const services: ServiceSection[] = [
  ...
  },
  {
    ...
    commonRequests: ['Business Cards', 'Flyers & Brochures', 'Letterheads', 'Print Marketing'],
  ...
  },
  {
    ...
    commonRequests: ['Storefront Signs', 'Wall Graphics', 'A-Frame Signs', 'Retractable Banners'],
  ...
  },
  {
    ...
    commonRequests: ['Frosted Film', 'Solar Film', 'Security Film', 'Decorative Film'],
    turnaround: '5-10 business days',
