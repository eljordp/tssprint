...
Status: on-site card checkout is deployed and enabled on tssprint.com. Real-money charge, receipt delivery, GA4 purchase and bank settlement remain unverified. On-site Apple Pay is deployed and enabled. Its official button and Chrome iPhone handoff are verified; a pointer-click follow-up fix is being released. A real phone authorization, capture, receipt, GA4 purchase and connector import remain pending. Updated 2026-09-15.
