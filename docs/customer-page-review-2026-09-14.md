...
| Events `/services/event-displays` | 7.5/10 | Real canopy/banner setup plus labeled event mockup. Frame versus graphic-only and accessories are clearer. Real Assam Convention installation photo now replaces the backdrop mockup and has a linked project detail. Finished table-cover photography remains needed. |
